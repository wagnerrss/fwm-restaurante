package com.fwm.restaurante.util;
...
public interface Util {
    ...
    public default boolean isFeriado() {
    ...
    public default String toJson(Map value,String encapsula){
        Gson gson = new Gson();
        Type gsonType = new TypeToken<HashMap>(){}.getType();

        if (!encapsula.equals("")){
            Map encap = new LinkedHashMap();
            encap.put(encapsula,value);
            return gson.toJson(encap,gsonType);
        }else{
    ...
    public default boolean conectaPeloGrupo(String grupo, UserDetailsService userDetailsService) {
